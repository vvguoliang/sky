...
/**
 * @Time : 2017/12/27 no 下午10:04
 * @USER : vvguoliang
 * @File : GestureDrawline.java
...
public class GestureDrawline extends View {
     ...
     * 用户绘图的回调 成功失败
     */
    private GestureSuccessCallBack checkedSuccess;
    ...
    public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
                           String passWord, GestureCallBack callBack, GestureSuccessCallBack checkedSuccess) {
        super(context);
        ...
        paint.setColor(Color.rgb(255, 58, 148));// 设置默认连线颜色
        ...
        this.checkedSuccess = checkedSuccess;
    ...
    private void drawErrorPathTip() {
        canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
        paint.setColor(Color.rgb(253, 107, 7));// 设置默认线路颜色
        for (Pair<GesturePoint, GesturePoint> pair : lineList) {
    ...
    public interface GestureSuccessCallBack {
        /**
         * 代表用户绘制的密码与传入的密码相同
         */
        void checkedSuccess();
