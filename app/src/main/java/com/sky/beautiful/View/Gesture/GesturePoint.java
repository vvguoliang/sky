...
/**
 * @Time : 2017/12/27 no 下午10:07
 * @USER : vvguoliang
 * @File : GesturePoint.java
    ...
    public void setPointState(int state) {
        ...
        switch (state) {
            case POINT_STATE_NORMAL:
                this.image.setImageResource(R.drawable.shape_gesture_black);
                break;
            case POINT_STATE_SELECTED:
                this.image.setImageResource(R.drawable.shape_gesture_pink_pink);
                break;
            case POINT_STATE_WRONG:
                this.image.setImageResource(R.drawable.shape_gesture_orange_orange);
                break;
            default:
                break;
        }
