...
public class BallView extends View {
    ...
    private int mCount = 15;   // 小球个数
    private int maxRadius;  // 小球最大半径
    private int minRadius; // 小球最小半径
    private int minSpeed = 20; // 小球最小移动速度
    private int maxSpeed = 80; // 小球最大移动速度
    ...
    public BallView(Context context) {
        ...
        int[] colors = randomColor.randomColor(mCount);
