package com.sky.beautiful.View.Gesture;
...
/**
 * @Time : 2017/12/27 no 下午10:03
 * @USER : vvguoliang
 * @File : GestureContentView.java
...
public class GestureContentView extends ViewGroup {
     ...
     */
    public GestureContentView(Context context, boolean isVerify, String passWord, GestureDrawline.GestureCallBack callBack, GestureDrawline.GestureSuccessCallBack gestureSuccessCallBack) {
        super(context);
        ...
        addChild();
        // 初始化一个可以画线的view
        gestureDrawline = new GestureDrawline(context, list, isVerify, passWord, callBack, gestureSuccessCallBack);
    }

    private void addChild() {
        for (int i = 0; i < 9; i++) {
            ImageView image = new ImageView(context);
            image.setImageResource(R.drawable.shape_gesture_black);
            this.addView(image);
            invalidate();
            // 第几行
            int row = i / 3;
