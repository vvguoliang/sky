...
/**
 * @Time : 2017/12/27 no 下午10:14
 * @USER : vvguoliang
 * @File : LockIndicator.java
...
public class LockIndicator extends View {
    ...
    public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        patternNoraml = getResources().getDrawable(R.drawable.shape_gesture_black);
        patternPressed = getResources().getDrawable(R.drawable.shape_pink_select);
