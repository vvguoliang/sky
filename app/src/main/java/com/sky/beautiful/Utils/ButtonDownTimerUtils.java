...
/**
 * @Time : 2017/12/27 no 下午3:45
 * @USER : vvguoliang
 * @File : ButtonDownTimerUtils.java
...
public class ButtonDownTimerUtils extends CountDownTimer {
     ...
     */
    public ButtonDownTimerUtils(Button textView, long millisInFuture, long countDownInterval) {
...
//        mButton.setBackgroundResource(R.drawable.bg_identify_code_press); //设置按钮为灰色，这时是不能点击的
        ...
        ForegroundColorSpan span = new ForegroundColorSpan( Color.parseColor( "#e31d1e" ) );
        /*
         * public void setSpan(Object what, int start, int end, int flags) {
         * 主要是start跟end，start是起始位置,无论中英文，都算一个。
         * 从0开始计算起。end是结束位置，所以处理的文字，包含开始位置，但不包含结束位置。
         */
        if (mButton.getText().toString().length() == 2) {
