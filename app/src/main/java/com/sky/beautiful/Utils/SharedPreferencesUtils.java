...
import com.sky.beautiful.Activity.GestureActivity;
...
public class SharedPreferencesUtils {
    ...
    public static Object get(Context context, String key, Object defaultObject) {
        ...
        if (defaultObject instanceof String) {
            ...
            return !"".equals(sp.getBoolean(key, (Boolean) defaultObject) + "") && sp.getBoolean(key, (Boolean) defaultObject);
    ...
    public static void logoutSuccess(Context content) {
        SharedPreferencesUtils.shareremvo(content, "userNo");
        SharedPreferencesUtils.shareremvo(content, "phone");
        SharedPreferencesUtils.shareremvo(content, "name");
        SharedPreferencesUtils.shareremvo(content, "sex");
        SharedPreferencesUtils.shareremvo(content, "age");
        SharedPreferencesUtils.shareremvo(content, "HeadUrl");
        SharedPreferencesUtils.shareremvo(content, "GradeNo");
        SharedPreferencesUtils.put(content, "isVerify1", false);
    }
}
